        ...
        <CardContent className="p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              {errors.delivery_days && <p className="text-xs text-red-500">{errors.delivery_days.message}</p>}
            </div>
            <div className="space-y-2">
              <Label htmlFor="validity_date">Bid Validity Date</Label>
              <Input id="validity_date" type="date" {...register('validity_date')} />
              {errors.validity_date && <p className="text-xs text-red-500">{errors.validity_date.message}</p>}
            </div>
          </div>
                ...
                <div key={field.id} className="flex flex-col md:flex-row gap-4 items-center border border-gray-100 dark:border-gray-850 p-4 rounded-lg bg-gray-50/50 dark:bg-gray-950/20">
                  ...
                  <div className="w-full md:w-48 space-y-2">
                    ...
                    {errors.items?.[idx]?.unit_price && (
                      <p className="text-xs text-red-500">{errors.items[idx].unit_price.message}</p>
                    )}
                  </div>
